        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Multiplier_Range", "reward_multiplier >= 0.1 AND reward_multiplier <= 10.0");
                    table.CheckConstraint("CK_OfflineMinutes_Positive", "effective_offline_minutes >= 0");
                    table.CheckConstraint("CK_Rewards_Positive", "experience_gained >= 0 AND gold_gained >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Enhancement_Level", "enhancement_level >= 0 AND enhancement_level <= 10");
                    table.CheckConstraint("CK_Quantity_Positive", "quantity > 0");
                    table.CheckConstraint("CK_Slot_Index", "slot_index >= -1 AND slot_index < 100");
                    table.ForeignKey(
