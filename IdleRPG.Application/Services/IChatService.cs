...
public interface IChatService
{
    ...
    /// <param name="playerId">발신자 Player ID (JWT에서 추출)</param>
    ...
    /// <exception cref="InvalidOperationException">쿨다운 위반 (1초 이내 재전송) 또는 캐릭터 미존재</exception>
    ...
    /// </summary>
    /// <param name="roomId">채팅방 ID</param>
    /// <param name="playerId">요청자 Player ID (JWT에서 추출, 권한 체크용)</param>
    ...
    /// <exception cref="NotFoundException">채팅방 미존재</exception>
    /// <exception cref="InvalidOperationException">캐릭터 미존재</exception>
    /// <exception cref="ForbiddenException">채팅방 접근 권한 없음</exception>
    ...
    /// - 내부적으로 Player.Id → Character.Id 변환 수행
    /// </remarks>
